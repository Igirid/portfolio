<template>
    <nav
        class="h-auto py-4 md:py-8 w-full sticky top-0 z-30 bg-blue-800"
        ref="nav"
    >
            ...
            <div class="flex justify-end md:px-8">
                <transition name="slide-fade">
                    <ul
                        @click.stop
                        v-if="responsiveNav"
                        class="bg-blue-800 text-gray-300 shadow-md md:shadow-none z-20 md:z-auto w-3/4 md:w-auto absolute -top-4 right-0 px-4 h-screen md:h-auto list-none md:static md:flex md:flex-row md:justify-between py-12 md:py-0"
                    >
                        ...
                        <li
                            class="mt-4 sm:mt-8 md:my-0 border-2 h-8 border-gray-200 md:mx-2 rounded-md w-max ml-2"
                        >
                            <a
                                href="/resume"
                                target="blank"
