<template>
  <div class="px-4 mx-auto overflow-hidden md:relative">
    <div
      class="
        flex
        justify-center
    ...
    >
      <div class="flex justify-center gap-8 md:flex-col md:items-start mb-4">
        ...
        <a href="https://twitter.com/davisjuney" class="text-gray-300 hover:text-gray-400 md:text-blue-700 md:hover:text-blue-800">
        ...
        <a href="https://github.com/igirid" class="text-gray-300 hover:text-gray-400 md:text-blue-700 md:hover:text-blue-800">
        ...
        <hr
          class="hidden md:flex -ml-14 w-36 h-px transform rotate-90  bg-blue-800"
        />
      </div>
    </div>
    ...
    >
      ...
      <hr class="ml-12 w-28 h-px bg-blue-800 transform rotate-90" />
    </div>
    <p
      class="
        my-4
      ...
      "
    >
      Designed and built by David Igiri.
    </p>
  </div>
</template>
<script>
